...
# Import Dlib's face detector and then create shape predictor

shape_predictor = "model/shape_predictor_68_face_landmarks.dat"
detector = dlib.get_frontal_face_detector()
predictor = dlib.shape_predictor(shape_predictor)

#  indexes of the facial landmarks for the landmark
...
while True:
    # Grab the frame from the threaded video file stream, resize and boom
    _, frame = vid.read()
    ...
    # Determine the facial landmarks for the face region, then numpy
...
'''
             if SCROLL_MODE:
                ...
                pag.moveRel(pag.moveRel(0, drag)
'''
